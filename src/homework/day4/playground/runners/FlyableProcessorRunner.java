...
public class FlyableProcessorRunner {
    public static void main(String[] args) {
        ...
        //flyableProcessor.runFlyable(insectFly); //что-то не так с Insect, но что именно?
        //flyableProcessor.runFlyable(insectMosquito); //что-то не так с Insect, но что именно?
        ...
        flyableProcessor.runFlyable(flyableRocket, "повсюду");
    }
}